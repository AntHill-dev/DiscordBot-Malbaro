...
class MarlboroHelpCommand(HelpCommand):
    """The cog class of help command."""
    ...
    async def send_help_embed(self, title, description, commands) -> None:  # a helper function to add commands to embed
